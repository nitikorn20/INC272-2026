...
// Demo 11 — Create Knob Widgets (UI only, no simulator)
// Purpose: learn how to create Knob widgets and link them to Gauge widgets.
// To see knobs connected to the simulator (PWM control), see web_apps/web06_knob_pwm.
